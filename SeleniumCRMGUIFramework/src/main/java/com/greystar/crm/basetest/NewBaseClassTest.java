package com.greystar.crm.basetest;
...
public class NewBaseClassTest {
	...
	// public void configBC(String browser) {//From the Parameters it comes here in
	// browser
	@BeforeClass
	public void configBC(String browser) {
		...
		/*
		 * String BROWSER = browser; if(BROWSER.equals("chrome")) { driver = new
		 * ChromeDriver(); } else if(BROWSER.equals("firefox")) { driver = new
		 * ChromeDriver(); } else if(BROWSER.equals("edge")) { driver = new
